...
<div class="max-w-screen-xl p-4 bg-white dark:bg-gray-800 mx-auto px-4 sm:px-6 lg:px-8 relative py-26 lg:mt-20 mt-6">
    <div class="relative">
        <div class="lg:grid lg:grid-flow-row-dense lg:grid-cols-2 lg:gap-8 lg:items-center">
            <div class="lg:col-start-2 lg:max-w-2xl ml-auto">
                ...
                <h4 class="mt-2 text-3xl leading-8 font-extrabold text-gray-900 dark:text-white sm:text-3xl sm:leading-9 font-bebas-neue">
                    Multiple languages and many core design elements
                </h4>
                <p class="mt-4 text-lg leading-6 text-gray-500 dark:text-gray-300 font-mono">
