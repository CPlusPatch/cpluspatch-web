...
<div class="bg-gray-800 flex relative z-20 items-center overflow-hidden">
	<div class="container mx-auto px-6 relative py-16">
		...
		<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 2xl:grid-cols-4 gap-5">
			...
			@include("components.projects.project-card", ["bg" => "/cdn/cppweb-banner.jpg", "category" => "Project", "title" => "CPlusPatch.com", "desc" => "My own website (developed in Laravel and TailwindCSS). I use it to keep all of my projects and for my public facade. My latest project.", "date" => "2021 - 2022", "link" => "https://cpluspatch.com"])
			@include("components.projects.project-card", ["bg" => "/cdn/mc-server-banner.png", "category" => "Project", "title" => "Minecraft server", "desc" => "Yes, I do run my own Minecraft server. If you are interested in it, please feel free to mail me or PM me on Discord. The server is Bedrock compatible.", "date" => "2021 - 2022", "link" => "https://discord.gg/TU5cCS6EpP", "linkText" => "Discord invite"])
			@include("components.projects.project-card", ["bg" => "/cdn/discord-bot-demo.png", "category" => "Project", "title" => "Discord bot", "desc" => "I made a bot. All it does is make bad jokes really. Also it sends meme and cringe pics when asked to. Peak coding.", "date" => "2022", "link" => "https://github.com/CPlusPatch/cpluspatch-bot", "linkText" => "GitHub repo"])
			@include("components.projects.project-card", ["bg" => "/cdn/discord-status-slideshow-banner.gif", "category" => "Project", "title" => "Discord status slideshow", "desc" => "A simple Node.js program that changes your currently playing status to cool things after a few seconds. It's a slideshow!", "date" => "2022", "link" => "https://github.com/CPlusPatch/discord-status-slideshow", "linkText" => "GitHub repo"])
		</div>
	</div>
</div>
